...
## 145060 Programming · Unit 5 · Tuesday, November 24 · Build 2
...
This is the last Gate 2 of Unit 5, so it uses the whole unit: CSV, cleaning, dictionaries,
sets, calculated fields, JSON, and files and folders.

The program is `gate2-w12-files/resale_report.py`, with two sheets in
`gate2-w12-files/sheets/`. **Copy the whole `gate2-w12-files` folder somewhere in your own
