...
## 145060 Programming · Unit 6 · Thursday, December 10 · Independent
...
**Files:** `07-gate2-adversarial/gate2-w14-files/fundraiser_report.py` and `sales.csv`. The code and a real
...
**Make a copy of the data file first.** In the `gate2-w14-files` folder, copy `sales.csv` to a new file named
