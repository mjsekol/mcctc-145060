...
## 145060 Programming · Unit 6 · November 30 - December 18, 2026
...
with no instruction at all. **Acceptance demo:** Friday, December 18.
...
The week of December 7 is BPA Regional. Some of your teammates will be competing.
...
words as though they said them to you, because on Tuesday, December 1, they will.
...
> it mostly works. Over long weekends and breaks, plants die, and winter break is
...
December 1, and your instructor approves it by the end of Build 1 that day. The
...
| Merge the change request straight into `main` | Wednesday, December 16 is about protecting an accepted baseline. The change goes on a branch and gets reviewed first. |
...
|---|---|---|
| **Define** | Mon Nov 30, end of Build 2 | Charter draft: problem statement, stakeholder, scope in and out, roles and backups, working agreement |
| **Define** | Tue Dec 1, end of Build 2 | Requirements v1 with acceptance criteria, question log started |
| **Measure** | Wed Dec 2, end of Build 2 | Baseline measurement of how the stakeholder does it today, constraints list, timeline on class days |
| **Measure** | Thu Dec 3, end of Build 2 | Acceptance test file with every check written and failing, test plan |
| **Gate** | Fri Dec 4, end of Build 2 | Stakeholder signs requirements and acceptance tests. Week 14 plan written. |
| **Analyze** | Tue Dec 8, end of Build 1 | Design notes: every function with its docstring and inputs and outputs, data file shapes, top three risks |
| **Improve** | Fri Dec 11, end of Build 1 | Sprint 1 increment: a runnable program and a written sprint review listing which checks pass |
| **Improve** | Mon Dec 14, end of Build 2 | Peer code review 1 received and written |
| **Improve** | Tue Dec 15, end of Build 2 | Review findings triaged by consensus and fixed. Every acceptance check passes. |
| **Control** | Wed Dec 16, end of Build 1 | Tag `v1.0` on `main`. Change impact record for the change request. |
| **Control** | Thu Dec 17, end of Build 1 | Peer code review 2 on the change branch, merged, tagged `v1.1` |
| **Control** | Fri Dec 18, end of block | Acceptance demo, control plan, retrospective |

**Measure is the phase teams skip and it is the one that decides the demo.** On
December 18 the stakeholder does not ask whether you worked hard. They run the
acceptance tests they signed on December 4. A team with vague criteria cannot pass
...
|---|---|---|---|
| 1 | Mon Nov 30 | Team formed, roles and backups, working agreement | Define: charter draft |
| 2 | Tue Dec 1 | Interview questions prepared, practice transcript | Four-minute stakeholder interview, requirements v1 |
| 3 | Wed Dec 2 | Constraints and baseline measurement | Timeline on class days, including Week 14 |
| 4 | Thu Dec 3 | Lab U06-01, tests for code you did not write | Your own acceptance tests, all failing, and the test plan |
| 5 | Fri Dec 4 | Gate 2 W13 | Stakeholder sign-off. Week 14 plan. |
| 6 | Mon Dec 7 | **BPA.** Lab U06-02 Sprint Board, Part 1 | Analyze: design notes |
| 7 | Tue Dec 8 | **BPA.** Lab U06-02, Part 2, and design notes due | Sprint 1 planning, then build |
| 8 | Wed Dec 9 | **BPA.** Build | Build |
| 9 | Thu Dec 10 | Gate 2 W14, independent | Build |
| 10 | Fri Dec 11 | **BPA presentations.** Written sprint review | Catch-up and Gate 1 reps |
| 11 | Mon Dec 14 | Lab U06-03 Structured Peer Review | Peer code review 1 |
| 12 | Tue Dec 15 | Gate 2 W15 | Triage findings by consensus, fix, all checks pass |
| 13 | Wed Dec 16 | Tag `v1.0`, change request arrives, impact record | Build the change on a branch |
| 14 | Thu Dec 17 | Peer code review 2, merge, tag `v1.1` | Problem Drop #3, individual |
| 15 | Fri Dec 18 | Acceptance demos | Unit quiz, then retrospective |

**Week 14 is written out day by day** in
[`MCCTC_145060_Guide_W14_SelfDirectedSprint.md`](MCCTC_145060_Guide_W14_SelfDirectedSprint.md).
Read it on Friday, December 4, before you leave. Nobody will be available to explain
it on Monday.
...
- **Review 1, Monday December 14.** Your team reviews another team's Sprint 1 code.
  Another team reviews yours.
- **Review 2, Thursday December 17.** Your team reviews another team's change branch
...
Friday, December 18. Five minutes per team, with the stakeholder in the room.
...
| **Process** | 15 | DMAIC deliverables on their due dates. Stand-up log kept, including Week 14. Commits from every member across the sprint. Baseline tagged. |
...
December 17. Commit at the end of every block, every day, including Week 14.
...
**"Our tests all fail."** On December 3, that is correct. Tests written before the code
...
Cutting on December 17 is not a decision. It is a surrender.
