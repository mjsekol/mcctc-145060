...
- Push everything before you leave.
Speaker notes: Build one is Peer Code Review two. You review another team's change branch against their v one point oh baseline before it touches main. Ask the change questions, especially what the change removed. After the review, merge and tag v one point one. Build two is Problem Drop three, individually, forty minutes. The stated problem is not the real problem, so read it twice. And push everything before you leave this room.
