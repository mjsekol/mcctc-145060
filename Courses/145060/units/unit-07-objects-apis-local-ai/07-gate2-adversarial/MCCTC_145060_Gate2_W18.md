...
## 145060 Programming · Unit 7 · Friday, January 22
...
The program is `gate2-w18-files/study_streak.py`. Its `tip` command talks to a fixture,
...
The code is in `gate2-w18-files/study_streak.py`. Try it:
