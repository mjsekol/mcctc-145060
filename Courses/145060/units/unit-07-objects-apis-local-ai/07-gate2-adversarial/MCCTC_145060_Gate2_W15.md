...
## 145060 Programming · Unit 7 · Week 15, Friday
...
The program is `gate2-w15-files/playlist.py`. Copy it and run it.
...
The code is in `gate2-w15-files/playlist.py`. Run it:
